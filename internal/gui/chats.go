...
func makeChatBox() fyne.CanvasObject {
	...
	chat1.Refresh()
	chat2 := widget.NewLabel("Hello this is a message from aliceAnd this is another reply from client to showcase text wrappingAnd this is another reply from client to showcase text wrappingAnd this is another reply from client to showcase text wrappingAnd this is another reply from client to showcase text wrapping")
